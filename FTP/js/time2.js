...
{  
        var str = '<div id="calendarPanel" style="position: fixed;display: none;z-index:99999999999999999999999999999999999999; background-color: #FFFFFF;border: 1px solid #CCCCCC;width:175px;font-size:12px;"></div>';  
        if(document.all)  
        {  
